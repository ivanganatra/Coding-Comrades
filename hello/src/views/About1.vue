<template>
  ...
  <div class="w3-bar-block">
    ...
    <!-- <a href="#contact" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Contact</a> -->
        ...
        <h1>Field : {{idd}}</h1>
         <div id="con">
     <div v-for="(index,iddd) in list" :key="index" :index="idd">
      <router-link :to="{ name: 'About2', params: { id:index,ip:iddd+1,ii:idd} }" :key="$route.path">
...
export default {
    ...
    data(){
        return{
            idd:this.id,
            list:["DBMS","OOP","CN","OS","DS","ALGORITHMS","AI-ML","PLACEMENTS"],
